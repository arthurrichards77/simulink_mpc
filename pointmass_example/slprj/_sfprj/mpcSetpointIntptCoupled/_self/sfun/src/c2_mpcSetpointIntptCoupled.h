#ifndef __c2_mpcSetpointIntptCoupled_h__
#define __c2_mpcSetpointIntptCoupled_h__
...
typedef struct {
  ...
  uint8_T c2_is_active_c2_mpcSetpointIntptCoupled;
  SimStruct *S;
...
extern void c2_mpcSetpointIntptCoupled_method_dispatcher(SimStruct *S, int_T
  method, void *data);
