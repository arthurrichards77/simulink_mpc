...
void load_default_data(void) {
  ...
  params.Fu[0] = -0.06565787059365391;
  params.Fu[1] = -0.5512951504486665;
  params.f[0] = 0.8307464872626844;
  params.f[1] = 0.9869848924080182;
  ...
  params.Ff[6] = -0.6967713677405021;
  params.Ff[7] = -0.21941980294587182;
  params.Ff[8] = -1.753884276680243;
  params.Ff[9] = -1.0292983112626475;
  params.Ff[10] = 1.8864104246942706;
  params.Ff[11] = -1.077663182579704;
  params.ff[0] = 0.7659100437893209;
  params.ff[1] = 0.6019074328549583;
  params.ff[2] = 0.8957565577499285;
  params.ff[3] = -0.09964555746227477;
  params.Ef[0] = 0.38665509840745127;
  params.Ef[1] = -1.7321223042686946;
  params.Ef[2] = -1.7097514487110663;
  params.Ef[3] = -1.2040958948116867;
  params.Ef[4] = -1.3925560119658358;
  params.Ef[5] = -1.5995826216742213;
  params.Ed[0] = -1.4828245415645833;
  params.Ed[1] = 0.21311092723061398;
  params.Ed[2] = -1.248740700304487;
  params.Ed[3] = 1.808404972124833;
  params.Ed[4] = 0.7264471152297065;
  params.Ed[5] = 0.16407869343908477;
  params.ef[0] = 0.8287224032315907;
  params.ef[1] = -0.9444533161899464;
}
