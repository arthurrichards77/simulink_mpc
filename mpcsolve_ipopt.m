function [z,info] = mpcsolve_ipopt(H,g,P,h,C,b,z0,A,B,Fx,Fu,Ff,Q,R,Qf,opts,Ps,hs,Ef,Fxs,Fus)
...
% open data file
fid = fopen('mpcdata.dat');

AMPLscalarint(fid,'n',n);
AMPLscalarint(fid,'m',m);
AMPLscalarint(fid,'ell',ell);
AMPLscalarint(fid,'ells',ells);
AMPLscalarint(fid,'ellf',ellf);
AMPLscalarint(fid,'ellef',ellef);
AMPLscalarint(fid,'T',T);
