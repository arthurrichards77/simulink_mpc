...
codegen mpcsolve_outer -c -d ../ks_solver_c/mpclib -config:lib -report -args {c_x,c_xt,c_d,c_H,c_g,c_gt,c_P,c_hc,c_hx,c_C,c_bx,c_bd,c_z0,c_A,c_B,c_Fx,c_Fu,c_Ff,c_Q,c_R,c_Qf,c_opts,c_Ps,c_hcs,c_hxs,c_Ef,c_Fxs,c_Fus}
